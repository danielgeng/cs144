...
AutoSuggestions.prototype.requestSuggestions = function (oAutoSuggestControl, bTypeAhead) {
	var xhr = new XMLHttpRequest();
    var aSuggestions = [];
    var request = "/eBay/suggest?q=" + encodeURI(oAutoSuggestControl.textbox.value);
